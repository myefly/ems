                                  ...
                                  <?php
                                    ...
                                    if ($rrs == ""){
                                    	...
                                    	foreach($rrs as $rr){
                                            ...
                                            echo "<td><a title='编辑'  onclick=\"xadmin.open('编辑','zycst_add.php?act=edit&szy_id=".$rr['ic_id']."',1080,600)\" href='javascript:;'>
                                            <i class='layui-icon'>&#xe642;</i>
                                          </a> | <a title='删除' onclick=\"s_del(this,'".$rr['ic_id']."')\" href='javascript:;'>
...
function s_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: "get",
			url: "ss_check.php?act=del&ss_id=" + id,
