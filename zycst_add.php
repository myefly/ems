        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width: 100px;">
            <select name="sszy_sex" id="sszy_sex">
              <option value="男" <?php if ($szy_sex == '男') {
                                  echo "selected";
                                } ?>>男</option>
              <option value="女" <?php if ($szy_sex == '女') {
                                  echo "selected";
                                } ?>>女</option>
            </select>
          </div>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width: 100px;">
            <select name="sszy_disease" id="sszy_disease">
              <option value="白内障" <?php if ($szy_disease == '白内障') {
                                    echo "selected";
                                  } ?>>白内障</option>
              <option value="翼状胬肉" <?php if ($szy_disease == '翼状胬肉') {
                                      echo "selected";
                                    } ?>>翼状胬肉</option>
            </select>
          </div>
          ...
          <div class="layui-input-inline" style="width: 100px;">
            <select name="sszy_opeye" id="sszy_opeye">
              <option value="右眼" <?php if ($szy_opeye == '右眼') {
                                    echo "selected";
                                  } ?>>右眼</option>
              <option value="左眼" <?php if ($szy_opeye == '左眼') {
                                    echo "selected";
                                  } ?>>左眼</option>
              <option value="双眼" <?php if ($szy_opeye == '双眼') {
                                    echo "selected";
                                  } ?>>双眼</option>
            </select>
          </div>
          ...
          <div class="layui-input-inline" style="width: 100px;">
            <select name="sszy_twoeye" id="sszy_twoeye">
              <option value="否" <?php if ($szy_twoeye == '否') {
                                  echo "selected";
                                } ?>>否</option>
              <option value="是" <?php if ($szy_twoeye == '是') {
                                  echo "selected";
                                } ?>>是</option>
            </select>
          </div>
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width: 100px;">
            <select name="sszy_charitable" id="sszy_charitable">
              <option value="否" <?php if ($szy_charitable == '否') {
                                  echo "selected";
                                } ?>>否</option>
              <option value="是" <?php if ($szy_charitable == '是') {
                                  echo "selected";
                                } ?>>是</option>
            </select>
          </div>
...
<script type="text/javascript">
  ...
  function show_opcost(obj, ia, ib) {
    $.ajax({
      url: "_func.php?act=sop&sdate=" + ia + "&sname=" + ib,
      async: false,
      type: "get",
      success: function(data) {
