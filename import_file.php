						...
						<div class="layui-card-body ">
							<div class="layui-tab">
								<ul class="layui-tab-title">
									<li <?php if ($_GET['itype'] == 'mz') {
											echo "class='layui-this'";
										} ?>>门诊数据样式</li>
									<li <?php if ($_GET['itype'] == 'zy') {
											echo "class='layui-this'";
										} ?>>住院数据样式</li>
									<li <?php if ($_GET['itype'] == 'sc') {
											echo "class='layui-this'";
										} ?>>筛查数据样式</li>
								</ul>
								<div class="layui-tab-content">
									<div class="layui-tab-item <?php if ($_GET['itype'] == 'mz') {
																	echo "layui-show";
																} ?>">
									...
									<div class="layui-tab-item <?php if ($_GET['itype'] == 'zy') {
																	echo "layui-show";
																} ?>">
										<table border="1" cellspacing="0" cellpadding="0">
											<tr style="text-align: center; font-weight: bold;">
									...
									<div class="layui-tab-item <?php if ($_GET['itype'] == 'sc') {
																	echo "layui-show";
																} ?>">
										<table border="1" cellspacing="0" cellpadding="0">
											<tr style="text-align: center; font-weight: bold;">
